...
public class DNSServer {
    ...
    private HashMap<Integer, DNSMessage> forwardedMessages;
    /**
	...
	cache = new DNSCache();
	forwardedMessages = new HashMap<Integer, DNSMessage>();
    ...
    private DatagramPacket handleReply(DNSMessage reply) {
        ...
        // TODO: match the reply to the original query
      	DNSMessage query = forwardedMessages.get(reply.getID()); 
        
	if (query == null) {
		System.out.println("No matching query found with ID: " + reply.getID());
		return null;
	}
